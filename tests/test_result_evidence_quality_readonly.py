...
def test_result_evidence_eval_does_not_write_workspace_files(capsys) -> None:
...
def test_result_evidence_eval_does_not_call_mutating_or_provider_surfaces(monkeypatch, capsys) -> None:
    root = workspace_with_result_evidence()
    capsys.readouterr()

    def forbidden(*args, **kwargs):
        raise AssertionError("result-evidence eval must be read-only")
